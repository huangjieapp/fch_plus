//
//  MJKDayStatisticalDetailViewController.m
//  Rebuild_newMJK
//
...
@interface MJKDayStatisticalDetailViewController ()<UITableViewDataSource, UITableViewDelegate>
/** tablevie*/
...
@implementation MJKDayStatisticalDetailViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	vc.createTime = [[self.timeStr substringToIndex:10] stringByAppendingString:@" 00:00:00"] ;
