...
#import "MJKSelectHourView.h"
#import "DBPickerView.h"
#import "LYSDatePickerController.h"


@interface MJKSelectHourView ()<LYSDatePickerSelectDelegate>
@end

@implementation MJKSelectHourView
...
- (instancetype)initWithFrame:(CGRect)frame withStart:(STARTBLOCK)start withEnd:(ENDBLOCK)end withSure:(SUREBLOCK)sure{
    if (self=[super initWithFrame:frame]) {
        ...
        self=[[[NSBundle mainBundle] loadNibNamed:NSStringFromClass([MJKSelectHourView class]) owner:self options:nil] lastObject];
        self.startB = start;
        self.endB = end;
        self.sureB = sure;
