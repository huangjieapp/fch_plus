...
@interface MJKTaskTypeSettingDetailViewController ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) UITableView *tableView;
@end

@implementation MJKTaskTypeSettingDetailViewController
...
- (void)clickEidtButton:(UIButton *)sender {
	MJKTaskTypeSettingEditViewController *editVC = [[MJKTaskTypeSettingEditViewController alloc]init];
