...
@interface MJKProductCategorySettingEditViewController ()<UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UIButton *saveButton;//保存按钮
@end

@implementation MJKProductCategorySettingEditViewController
...
- (void)initUI {
    self.navigationItem.title = @"产品分类修改";
