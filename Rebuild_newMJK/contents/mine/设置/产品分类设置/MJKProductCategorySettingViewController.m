...
#import "MJKProductCategorySettingViewController.h"
#import "MJKProductCategorySettingDetailViewController.h"
#import "MJKProductCategorySettingAddViewController.h"
...
@interface MJKProductCategorySettingViewController ()<UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation MJKProductCategorySettingViewController
...
- (void)initUI {
	...
	[self.view addSubview:self.headView];
		...
		self.headView.headTitleArray = @[@"分类名称", @""];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MJKProductCategorySettingEditViewController *detailVC = [[MJKProductCategorySettingEditViewController alloc]init];
...
- (void)addButtonAction:(UIButton *)sender {
		...
		MJKProductCategorySettingAddViewController *addVC = [[MJKProductCategorySettingAddViewController alloc]init];
...
- (void)HTTPGetMarkDatas {
    ...
    contentDic[@"C_TYPE_DD_ID"] = @"A70600_C_TYPE_0000";
    contentDic[@"ISPAGE"] = @"1";
