...
@interface MJKProductCategorySettingAddViewController ()<UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
...
@implementation MJKProductCategorySettingAddViewController
...
- (void)viewDidLoad {
    ...
    self.productModel.C_TYPE_DD_ID = @"A70600_C_TYPE_0000";
}
