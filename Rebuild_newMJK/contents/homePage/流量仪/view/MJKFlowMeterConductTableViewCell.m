//
//  MJKFlowMeterConductTableViewCell.m
//  Rebuild_newMJK
//
...
@implementation MJKFlowMeterConductTableViewCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
	static NSString *ID = @"MJKFlowMeterConductTableViewCell";
	MJKFlowMeterConductTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
	if (cell == nil) {
