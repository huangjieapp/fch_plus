...
@interface MJKNewScoialMarketTeamDetailTableViewCell ()
@property (strong, nonatomic) IBOutletCollection(UILabel) NSArray *nameLabelArray;
@property (weak, nonatomic) IBOutlet UILabel *detailLabel;

@end

@implementation MJKNewScoialMarketTeamDetailTableViewCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    static NSString *ID = @"MJKNewScoialMarketTeamDetailTableViewCell";
    MJKNewScoialMarketTeamDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
