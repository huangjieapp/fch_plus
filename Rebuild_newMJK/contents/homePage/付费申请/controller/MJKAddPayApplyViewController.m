...
#import "MJKAddPayApplyViewController.h"
...
@interface MJKAddPayApplyViewController ()<UITableViewDataSource, UITableViewDelegate>
/** list data array*/
...
@implementation MJKAddPayApplyViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([dic[@"title"] isEqualToString:@"备注"]) {
        ...
        return memoCell;
    } else if ([dic[@"title"] isEqualToString:@"报销金额"] || [dic[@"title"] isEqualToString:@"报销说明"] || [dic[@"title"] isEqualToString:@"开户人"] || [dic[@"title"] isEqualToString:@"账户"]) {
        AddCustomerInputTableViewCell *cell = [AddCustomerInputTableViewCell cellWithTableView:tableView];
        cell.inputTextField.keyboardType=([dic[@"title"] isEqualToString:@"报销金额"] || [dic[@"title"] isEqualToString:@"账户"]) ? UIKeyboardTypeNumberPad : UIKeyboardTypeDefault;
...
- (NSMutableArray *)listDataArray {
    if (!_listDataArray) {
        ...
        [section0Array addObject:[@{@"id" : @"supplierId", @"title" : @"供应商"} mutableCopy]];
        [section0Array addObject:[@{@"id" : @"bankId", @"title" : @"开户行"} mutableCopy]];
        [section0Array addObject:[@{@"id" : @"accountOpening", @"title" : @"开户人"} mutableCopy]];
        [section0Array addObject:[@{@"id" : @"supplierBank", @"title" : @"账户"} mutableCopy]];
