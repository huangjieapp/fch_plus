//
//  SHShopingMallViewController.m
//  mcr_sh_master
//
//  Created by 黄佳峰 on 2017/7/18.
...
@interface SHShopingMallViewController ()<JSDropDownMenuDataSource,JSDropDownMenuDelegate,UITableViewDelegate,UITableViewDataSource> {
...
@implementation SHShopingMallViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    OrderViewTableViewCell*cell=[tableView dequeueReusableCellWithIdentifier:CELL0];
    cell.selectionStyle=UITableViewCellSelectionStyleNone;
    
    cell.titleLabel.text=@"张怡宁";
    cell.subLabel.text=@"嘉实多-磁护4L";
    cell.rightTopLabel.text=@"已离店";
    cell.rightBottomLabel.text=@"花木店";
