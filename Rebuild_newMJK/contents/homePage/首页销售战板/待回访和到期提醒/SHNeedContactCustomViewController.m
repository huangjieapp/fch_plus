//
//  SHNeedContactCustomViewController.m
//  mcr_sh_master
//
...
#define CELL0    @"ContactCustomTableViewCell"
#define CELLHeader   @"IntoShopHeaderView"

@interface SHNeedContactCustomViewController ()<JSDropDownMenuDataSource,JSDropDownMenuDelegate,UITableViewDelegate,UITableViewDataSource> {
...
@implementation SHNeedContactCustomViewController

+(instancetype)needContactCustomWithType:(needContactCustomType)type{
    SHNeedContactCustomViewController*aaa=[[SHNeedContactCustomViewController alloc]init];
    if (aaa) {
         aaa.type=type;
    }
