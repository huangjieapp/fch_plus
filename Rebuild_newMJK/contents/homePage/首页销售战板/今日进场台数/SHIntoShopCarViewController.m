//
//  SHIntoShopCarViewController.m
//  mcr_sh_master
//
//  Created by 黄佳峰 on 2017/7/13.
...
#define CELL0    @"IntoShopTableViewCell"
#define CELLHeader   @"IntoShopHeaderView"

@interface SHIntoShopCarViewController () <JSDropDownMenuDataSource,JSDropDownMenuDelegate,UITableViewDelegate,UITableViewDataSource> {
...
@implementation SHIntoShopCarViewController
...
-(void)falseDatas{
    ...
    _data1=[NSMutableArray arrayWithObjects:@"时间",@"今天",@"最近7天",@"本周",@"本月",@"自定义", nil];
