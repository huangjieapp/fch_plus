...
typedef NS_ENUM(NSInteger,FansFollowUp){
    FansFollowUpAdd=0,   //新增
    FansFollowUpEdit,
	FansFollowUpNil
};


@protocol FansFollowAddEditViewControllerDelegate <NSObject>
-(void)DelegateCompletePopToDo;   //完成pop 之后要做的事情

@end


@interface FansFollowAddEditViewController : DBBaseViewController

//共有
@property(nonatomic,assign)FansFollowUp Type;
...
@property(nonatomic,assign)id<FansFollowAddEditViewControllerDelegate>delegate;
