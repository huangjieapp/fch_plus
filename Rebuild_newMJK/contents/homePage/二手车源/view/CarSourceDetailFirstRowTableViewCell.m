...
#import "CarSourceDetailFirstRowTableViewCell.h"
#import "CustomerDetailChooseView.h"


@interface CarSourceDetailFirstRowTableViewCell()
...
@implementation CarSourceDetailFirstRowTableViewCell
...
//    NSArray*localNumber=@[@"0",@"0",@"0",@"0",@"0",@"0",@"0",@"0"];
    NSArray*localName=@[@"跟进记录"];
    NSArray*localNumber=@[@"0"];
...
+ (instancetype)cellWithTableView:(UITableView *)tableView withType:(NSString *)strType{
	static NSString *ID = @"CarSourceDetailFirstRowTableViewCell";
	CarSourceDetailFirstRowTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
	if (cell == nil) {
...
-(void)setType:(NSString *)type{
	...
	if ([_type isEqualToString:@"customer"]) {
		...
		NSArray*localName=@[@"粉丝关怀",@"转介绍"];
		NSArray*localNumber=@[@"0",@"0"];
		CGFloat buttonViewWith=(KScreenWidth-(localName.count-1)*1)/localName.count;
