...
@interface MJKAddOrderFlowTableViewCell () <UITextFieldDelegate>
@property (nonatomic, assign) int peopleNumber;
@end

@implementation MJKAddOrderFlowTableViewCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
	static NSString *ID = @"MJKAddOrderFlowTableViewCell";
	MJKAddOrderFlowTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
	if (cell == nil) {
