...
//    NSLog(@"宽度：%f高度：%f",self.frame.size.width, self.frame.size.height);
    ...
    self.fristRowBackGround=[UIColor whiteColor]/*DBColor(229, 239, 254)*/;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_isLockFristColumn) {
		...
		cell.selectRowBlock = ^(NSString *name) {
			if (weakSelf.selectRowBlock) {
				weakSelf.selectRowBlock(name);
			}
		};
    ...
    if(_isLockFristRow){
        if(_isLockFristColumn){
           //如果第一列锁定
            ...
            lockView.textColor=[UIColor blackColor]; /*DBColor(94, 153, 251)*/;
            ...
            cell.lockView.layer.borderColor=kBackgroundColor.CGColor /*[UIColor whiteColor].CGColor*/;
            ...
            for (NSString *data in self.mFristRowDatas) {
                ...
                dataView.text=data;
                dataView.textColor=DBColor(94, 153, 251);
            ...
            for (NSString *data in _mFristRowDatas) {
                ...
                UILabel *dataView=[[UILabel alloc]initWithFrame:view.bounds];
                dataView.text=data;
                dataView.textColor=[UIColor blackColor]/*DBColor(94, 153, 251)*/;
                dataView.textAlignment=NSTextAlignmentCenter;
                dataView.numberOfLines=0;
                dataView.font=self.textFont;
                [view addSubview:dataView];
                view.layer.borderWidth=0.6;
                view.layer.borderColor=kBackgroundColor.CGColor/*[UIColor whiteColor].CGColor*/;
                view.layer.backgroundColor=self.fristRowBackGround.CGColor;
                [cell.scrollView addSubview:view];
                x+=view.frame.size.width;
                i++;
