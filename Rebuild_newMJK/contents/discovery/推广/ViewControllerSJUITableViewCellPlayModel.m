...
@interface ViewControllerSJUITableViewCellPlayModel ()< UITableViewDataSource, UITableViewDelegate>
...
//        self.player.needPresentModalViewControlller = YES;
        ...
        self.player.URLAsset = [[SJVideoPlayerURLAsset alloc] initWithURL:[NSURL URLWithString:@"http://cdn.51mcr.com/mp4/2019-01-16/adb70f27-73a4-4a88-a999-53ddad01d46a.mp4"] playModel:[SJPlayModel UITableViewCellPlayModelWithPlayerSuperviewTag:view.coverImageView.tag atIndexPath:indexPath tableView:self.tableView]];
