...
#define CellBackColor [UIColor colorWithRed:244.0f/255.0f green:244.0f/255.0f blue:244.0f/255.0f alpha:1.0]
//#define BackColor [UIColor greenColor]
// 选中颜色加深
...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(hiddenDropDown) name:@"hiddenDropDownMenu" object:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.selectedBackgroundView.backgroundColor = CellBackColor;
