...
-(void)initTopImageBottomTitle {
    UIImage *buttonImg = [self imageForState:UIControlStateNormal];
    CGFloat titleWidth = [self.titleLabel.text sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont boldSystemFontOfSize:12],NSFontAttributeName, nil]].width;
    [self setTitleEdgeInsets:UIEdgeInsetsMake(buttonImg.size.height, -buttonImg.size.width, 0, 0)];
    [self setImageEdgeInsets:UIEdgeInsetsMake(-20, 0, 0, -titleWidth)];
