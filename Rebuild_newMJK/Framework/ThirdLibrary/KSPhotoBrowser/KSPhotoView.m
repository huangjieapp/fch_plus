...
- (void)setTextStr:(NSString *)textStr {
    _textStr = textStr;
    CGSize size = [textStr boundingRectWithSize:CGSizeMake(KScreenWidth - 20, CGFLOAT_MAX) options:NSStringDrawingUsesFontLeading | NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:14.f]} context:nil].size;
    _textView.frame = CGRectMake(10, KScreenHeight - 100 - 10, KScreenWidth - 20, 100);
