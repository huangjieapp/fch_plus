...
- (void)dismissPopupViewControllerWithanimationType:(MJPopupViewAnimation)animationType
{
    ...
    switch (animationType) {
        ...
        case MJPopupViewAnimationSlideRightRight:
            ...
            break;
        case MJPopupViewAnimationFailWithNoAnimantion:
            [self fadeWithNoAnimationViewOut:popupView sourceView:sourceView overlayView:overlayView];
            break;
        default:
...
//消失时不添加动画
- (void)fadeWithNoAnimationViewOut:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView{
    [popupView removeFromSuperview];
    [overlayView removeFromSuperview];
    [self.mj_popupViewController viewDidDisappear:NO];
    self.mj_popupViewController = nil;
